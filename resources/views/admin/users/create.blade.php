    ...
    <div class="container mx-auto mt-10 flex items-center justify-center p-3 sm:p-4 lg:p-6">
        <div class="w-full max-w-xl rounded-2xl bg-white p-8 shadow-2xl">
            <div class="mb-8 text-center">
                <h3 class="text-3xl font-bold text-indigo-900">Thêm Mới Người Dùng</h3>
                <p class="mt-2 text-gray-500">Điền thông tin chi tiết để thêm người dùng mới.</p>
            </div>
            ...
            <form action="{{ route('admin.users.store') }}" method="POST">
                ...
                <div class="mb-6 flex flex-col gap-6 sm:flex-row">
                    <div class="w-full">
                        <label for="password" class="mb-2 block text-sm font-medium text-indigo-900">Mật khẩu</label>
                        <div class="relative">
                            <input type="password"
