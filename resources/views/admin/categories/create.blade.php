    ...
    <div class="container flex items-center justify-center mt-10 mx-auto p-3 sm:p-4 lg:p-6">
        <div class="max-w-xl w-full bg-white p-8 rounded-xl shadow-2xl">
            <div class="mb-8 text-center">
                <h3 class="text-3xl font-bold text-indigo-900">Thêm Mới Danh Mục</h3>
                <p class="text-gray-500 mt-2">Điền thông tin chi tiết để thêm danh mục mới.</p>
            </div>
            ...
            <form action="{{ route('admin.categories.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text"
                        ...
                        id="ten_danh_muc" name="ten_danh_muc" value="{{ old('ten_danh_muc') }}"
