    ...
    <div class="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart="multipart/form-data">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
                <div>
                    {{-- Tiêu đề chính --}}
                    <h1 class="text-3xl font-bold text-indigo-900">Thêm sản phẩm mới</h1>
                    <p class="mt-1 text-sm text-gray-600">Điền các thông tin dưới đây để tạo sản phẩm của bạn.</p>
                </div>
