    ...
    <div id="editStatusModal"
        ...
        <div id="modalContent"
            ...
            <form id="updateStatusForm" method="POST" action="">
                ...
                <div class="mb-6">
                    <label for="order_status" class="block text-sm font-semibold text-gray-700 mb-2">Trạng thái mới</label>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateStatusOptions(currentStatus) {
            ...
            options.forEach(option => {
                ...
                else if (optionStep && (optionStep === currentStep + 1 || optionValue === 'cancelled')) {
