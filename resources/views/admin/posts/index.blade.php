            ...
            <div class="rounded-xl bg-white p-6 shadow-md transition-all duration-300 hover:shadow-lg">
                <div class="mb-4 flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <!-- Nút Thùng rác cho Bài viết có thể được thêm ở đây -->
                        <!-- Ví dụ: <a href=""
                    ...
                    <form action="{{ route('admin.posts.index') }}" method="GET"
                        ...
                        <div class="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-4">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <button type="button" onclick="window.location='{{ route('admin.posts.index') }}'"
                                ...
                                @forelse($posts as $post)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="whitespace-nowrap px-3 py-2 text-sm text-gray-500">
                                            {{ \Illuminate\Support\Str::limit($post->tieu_de, 30) }}</td>
                                        <td class="px-3 py-2 text-sm text-gray-500">
                                            {{ \Illuminate\Support\Str::limit($post->noi_dung, 50) }}</td>
                                        <td class="whitespace-nowrap px-3 py-2 text-sm text-gray-500">
                                            @if ($post->hinh_anh)
                                                <img src="{{ asset('storage/' . $post->hinh_anh) }}" alt="Hình ảnh bài viết"
                                                    class="w-36 rounded-md object-cover">
                                            @else
                                                <span class="text-xs italic text-gray-400">Không có ảnh</span>
                                            @endif
                                        </td>
