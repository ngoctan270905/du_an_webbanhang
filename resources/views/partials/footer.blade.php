<footer>
    <div class="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8 lg:py-8 sm:py-6">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li><a href="{{ route('posts.list') }}" class="hover:text-yellow-400 transition-colors">Bài
                            viết trending</a></li>
                    <li><a href="{{ route('contact.form') }}" class="hover:text-yellow-400 transition-colors">Liên
                            hệ với chúng tôi</a></li>
